...
switch3 = digitalio.DigitalInOut(board.GP24)  # change for the final product
switch3.direction = digitalio.Direction.INPUT
switch3.pull = digitalio.Pull.UP

switch4 = digitalio.DigitalInOut(board.GP23)  # change for the final product
switch4.direction = digitalio.Direction.INPUT
switch4.pull = digitalio.Pull.UP

switchUp = digitalio.DigitalInOut(board.GP20)  # change for the final product
switchUp.direction = digitalio.Direction.INPUT
switchUp.pull = digitalio.Pull.UP

switchA = digitalio.DigitalInOut(board.GP9)  # change for the final product
switchA.direction = digitalio.Direction.INPUT
switchA.pull = digitalio.Pull.UP

switchB = digitalio.DigitalInOut(board.GP10)  # change for the final product
switchB.direction = digitalio.Direction.INPUT
switchB.pull = digitalio.Pull.UP

switchC = digitalio.DigitalInOut(board.GP11)  # change for the final product
switchC.direction = digitalio.Direction.INPUT
switchC.pull = digitalio.Pull.UP

switchD = digitalio.DigitalInOut(board.GP18)  # change for the final product
switchD.direction = digitalio.Direction.INPUT
switchD.pull = digitalio.Pull.UP

switchDown = digitalio.DigitalInOut(board.GP19)  # change for the final product
